...
class BookDB {
    ...
    public static function getAllBooks() {
        $books = array();
        $books[1] = new Book(1, "Prolog Programming for Artificial Intelligence", "Ivan Bratko", 39.99);
        $books[2] = new Book(2, "Arhitektura računalniških sistemov", "Dušan Kodek", 29.99);
        $books[3] = new Book(3, "Managing Information Systems Security and Privacy", "Denis Trček", 19.99);
        $books[4] = new Book(4, "Študijski koledar", "FRI", 0.00);
